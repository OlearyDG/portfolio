 ...
 //}
   ...
   if(baclist[i].getS()==0){
     ...
     if(Math.random()<=mut){
       ...
       //console.log(hex(c));
       baclist.push(new Bacteria(this.x,this.y,c));
     }else{
       baclist.push(new Bacteria(this.x,this.y,this.col));
     }
  ...
  if(Math.random()<=mut){
       let c= color(random(0,255),random(0,255),random(0,255));
      // console.log(hex(c));
       baclist.push(new Bacteria(this.x,this.y,random(0,2),c));
     }else{
       baclist.push(new Bacteria(this.x,this.y,random(0,2),this.col));
     }
   }
   }
   }
